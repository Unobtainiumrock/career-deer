    ...
    if (this.props.pwReset.status) {
        ...
        >
          <Container>
            ...
            <Row className="justify-content-center text-center">
              <Col className="montserrat">
                <h3>
                  An email has been sent for a link to reset your password.
                </h3>
                <h4>
                  Click <Link to="/login">here</Link> to return back to the herd
                </h4>
              </Col>
            </Row>
          </Container>
      ...
      return (
        <Container>
          ...
          <ResetPWForm
            onSubmitForm={this.requestPWReset}
            errorMessage={this.props.pwReset.error}
          />
        </Container>
      );
    }
